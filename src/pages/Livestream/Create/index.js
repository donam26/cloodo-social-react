...
const CreateLivestream = () => {
  ...
  const { mutate: createLiveStream, isPending: isCreatingLiveStream } = useCreateLiveStream();
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            size="large"
            icon={<FaVideo />}
            disabled={!cameraPermission || isCreatingLiveStream}
            loading={isCreatingLiveStream}
            block
          >
            {isCreatingLiveStream ? "Đang tạo..." : "Bắt đầu phát trực tiếp"}
          </Button>
        </div>
      </form>
    </Card>
